...
export default function Header() {
  ...
  return (
    <div className='w-[100%] h-[100px] bg-[#2B2C37] flex justify-between items-center px-8 border-b-[.01em] border-[#3E3F4E]'>
        ...
        <button type='button' className=' flex md:hidden text-white font-bold text-l' ref={drop_down_btn} onClick={() => setDropDown(true)}>Marketing Plan <svg className='ml-4 mt-3' width="10" height="7" xmlns="http://www.w3.org/2000/svg"><path stroke="#635FC7" strokeWidth="2" fill="none" d="m1 1 4 4 4-4"></path></svg></button>
        {activeBoard?.length ?
          <div>
