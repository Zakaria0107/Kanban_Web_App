...
export default function Container() {
  ...
  return (
    <div className='bg-[#20212C]  h-[calc(100vh-100px)] '>
        ...
        {data?.length ? <div className='w-[280px] h-[100%] m-4  mt-14 shrink-0 bg-[#2B2C37] flex justify-center items-center cursor-pointer hover:opacity-50 duration-300 rounded-lg group' onClick={() => setAddColumn(true)}>
